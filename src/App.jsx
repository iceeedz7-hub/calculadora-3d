...
const IMPRESSORAS = [
  { marca:"Creality", serie:"Ender", modelo:"Ender 2 Pro" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V2" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 Neo" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V2 Neo" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 S1" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 S1 Pro" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 S1 Plus" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 Max" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 Max Neo" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V3 SE" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V3 KE" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V3" },
  { marca:"Creality", serie:"Ender", modelo:"Ender 3 V3 Plus" },
  { marca:"Creality", serie:"Ender 5", modelo:"Ender 5" },
  { marca:"Creality", serie:"Ender 5", modelo:"Ender 5 Pro" },
  { marca:"Creality", serie:"Ender 5", modelo:"Ender 5 Plus" },
  { marca:"Creality", serie:"Ender 5", modelo:"Ender 5 S1" },
  { marca:"Creality", serie:"CR", modelo:"CR-6 SE" },
  { marca:"Creality", serie:"CR", modelo:"CR-6 Max" },
  { marca:"Creality", serie:"CR", modelo:"CR-10" },
  { marca:"Creality", serie:"CR", modelo:"CR-10S" },
  { marca:"Creality", serie:"CR", modelo:"CR-10 V2" },
  { marca:"Creality", serie:"CR", modelo:"CR-10 V3" },
  { marca:"Creality", serie:"CR", modelo:"CR-10 Smart" },
  { marca:"Creality", serie:"CR", modelo:"CR-10 Smart Pro" },
  { marca:"Creality", serie:"CR", modelo:"CR-10 SE" },
  { marca:"Creality", serie:"CR", modelo:"CR-M4" },
  { marca:"Creality", serie:"K", modelo:"K1" },
  { marca:"Creality", serie:"K", modelo:"K1 SE" },
  { marca:"Creality", serie:"K", modelo:"K1C" },
  { marca:"Creality", serie:"K", modelo:"K1 Max" },
  { marca:"Creality", serie:"K", modelo:"K2 Plus" },
  { marca:"Creality", serie:"Hi", modelo:"Creality Hi" },
  { marca:"Creality", serie:"Hi", modelo:"Creality Hi Combo" },
  { marca:"Creality", serie:"Sermoon", modelo:"Sermoon D1" },
  { marca:"Creality", serie:"Sermoon", modelo:"Sermoon D3" },
  { marca:"Creality", serie:"Sermoon", modelo:"Sermoon V1 Pro" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot One" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot One Pro" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot One Plus" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot Mage" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot Mage Pro" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot Mage S" },
  { marca:"Creality", serie:"Halot (Resina)", modelo:"Halot Sky" },
  { marca:"Bambu Lab", serie:"A1", modelo:"A1 Mini" },
  { marca:"Bambu Lab", serie:"A1", modelo:"A1" },
  { marca:"Bambu Lab", serie:"P1", modelo:"P1P" },
  { marca:"Bambu Lab", serie:"P1", modelo:"P1S" },
  { marca:"Bambu Lab", serie:"X1", modelo:"X1" },
  { marca:"Bambu Lab", serie:"X1", modelo:"X1 Carbon" },
  { marca:"Bambu Lab", serie:"X1", modelo:"X1E" },
  { marca:"Bambu Lab", serie:"Acessorios", modelo:"AMS" },
  { marca:"Bambu Lab", serie:"Acessorios", modelo:"AMS Lite" },
  { marca:"Bambu Lab", serie:"Acessorios", modelo:"AMS 2 Pro" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 3" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 3 Pro" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 4" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 4 Pro" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 5M" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 5M Pro" },
  { marca:"Flashforge", serie:"Adventurer", modelo:"Adventurer 5X" },
  { marca:"Flashforge", serie:"Creator", modelo:"Creator Pro" },
  { marca:"Flashforge", serie:"Creator", modelo:"Creator Pro 2" },
  { marca:"Flashforge", serie:"Creator", modelo:"Creator 3" },
  { marca:"Flashforge", serie:"Creator", modelo:"Creator 4" },
  { marca:"Flashforge", serie:"Guider", modelo:"Guider 2" },
  { marca:"Flashforge", serie:"Guider", modelo:"Guider 2S" },
  { marca:"Flashforge", serie:"Guider", modelo:"Guider 3" },
  { marca:"Flashforge", serie:"Guider", modelo:"Guider 3 Ultra" },
  { marca:"Flashforge", serie:"Dreamer", modelo:"Dreamer" },
  { marca:"Flashforge", serie:"Dreamer", modelo:"Dreamer NX" },
  { marca:"Flashforge", serie:"Finder", modelo:"Finder" },
  { marca:"Flashforge", serie:"Finder", modelo:"Finder 3" },
  { marca:"Flashforge", serie:"Foto (Resina)", modelo:"Foto 6.0" },
  { marca:"Flashforge", serie:"Foto (Resina)", modelo:"Foto 8.9" },
  { marca:"Flashforge", serie:"Foto (Resina)", modelo:"Foto 9.25" },
  { marca:"Flashforge", serie:"Foto (Resina)", modelo:"Foto 13.3" },
];
    ...
    <div ref={ref} style={{position:"relative"}}>
      ...
      <div style={{position:"relative"}}>
        <input
          ...
          onFocus={()=>{setAberto(true);if(value)setBusca("");}}
      ...
      {aberto&&(
        <div style={{position:"absolute",top:"calc(100% + 6px)",left:0,right:0,zIndex:999,background:C.surface,border:`1px solid ${C.accent}44`,borderRadius:14,boxShadow:"0 16px 48px rgba(0,0,0,0.6)",maxHeight:300,overflowY:"auto"}}>
        ...
        {aba==="calculadora"&&(
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <Card step="02" icon="P" title="Impressora" delay={2}>
              <PrinterSelector value={form.impressora} onChange={v=>setForm(f=>({...f,impressora:v}))} />
            </Card>
            ...
            <Card step="06" icon="E" title="Energia" delay={6}>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                <NI label="Consumo da impressora" name="printerWatts" value={form.printerWatts} onChange={handleChange} placeholder="350" unit="W" hint="Creality Hi aprox 300-400W" />
